...
class DetailedAthlete(object):
    ...
    swagger_types = {
        ...
        # SS manually added from summary Athlete
        'resource_state': 'int',
        'firstname': 'str',
        'lastname': 'str',
        'profile_medium': 'str',
    ...
    def __init__(self, follower_count=None, friend_count=None,
                 measurement_preference=None, ftp=None,
                 weight=None, clubs=None, bikes=None,
                 shoes=None, _configuration=None,

                 # SS added:
                 resource_state=None, firstname=None, lastname=None,
                 profile_medium=None, profile=None, city=None, state=None,
                 country=None, sex=None, premium=None, summit=None,
                 created_at=None, updated_at=None, id=None):  # noqa: E501
    ...
    def measurement_preference(self, measurement_preference):
        ...
        if (self._configuration.client_side_validation and
                measurement_preference not in allowed_values):
            raise ValueError(
