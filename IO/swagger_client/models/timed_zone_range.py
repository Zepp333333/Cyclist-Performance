...
class TimedZoneRange(ZoneRange):
    ...
    if hasattr(ZoneRange, "swagger_types"):
        swagger_types.update(ZoneRange.swagger_types)

    attribute_map = {
        'time': 'time'
    }
    if hasattr(ZoneRange, "attribute_map"):
        attribute_map.update(ZoneRange.attribute_map)

    def __init__(self, time=None, *args, **kwargs):  # noqa: E501
        """TimedZoneRange - a model defined in Swagger"""  # noqa: E501
        self._time = None
        self.discriminator = None
        if time is not None:
            self.time = time
        ZoneRange.__init__(self, *args, **kwargs)
