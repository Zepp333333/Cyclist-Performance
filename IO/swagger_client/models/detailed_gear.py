...
class DetailedGear(SummaryGear):
    ...
    if hasattr(SummaryGear, "swagger_types"):
        swagger_types.update(SummaryGear.swagger_types)
    ...
    if hasattr(SummaryGear, "attribute_map"):
        attribute_map.update(SummaryGear.attribute_map)

    def __init__(self, brand_name=None, model_name=None, frame_type=None, description=None, *args, **kwargs):  # noqa: E501
        ...
        SummaryGear.__init__(self, *args, **kwargs)
