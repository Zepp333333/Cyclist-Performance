...
class RunningRace(object):
    ...
    def __init__(self, id=None, name=None, running_race_type=None, distance=None, start_date_local=None, city=None, state=None, country=None, route_ids=None, measurement_preference=None, url=None, website_url=None, _configuration=None):  # noqa: E501
