...
class DetailedActivity(object):
    ...
    def __init__(self, description=None, photos=None, gear=None, calories=None,
                 segment_efforts=None, device_name=None, embed_token=None,
                 splits_metric=None, splits_standard=None, laps=None, best_efforts=None,
                 # SS added
                 id=None, external_id=None, upload_id=None, athlete=None,
                 name=None, distance=None, moving_time=None, elapsed_time=None,
                 total_elevation_gain=None, elev_high=None, elev_low=None,
                 type=None, start_date=None, start_date_local=None, timezone=None,
                 start_latlng=None, end_latlng=None, achievement_count=None,
                 kudos_count=None, comment_count=None, athlete_count=None,
                 photo_count=None, total_photo_count=None, map=None, trainer=None,
                 commute=None, manual=None, private=None, flagged=None, workout_type=None,
                 upload_id_str=None, average_speed=None, max_speed=None, has_kudoed=None,
                 gear_id=None, kilojoules=None, average_watts=None, device_watts=None,
                 max_watts=None, weighted_average_watts=None,
    ...
    def athlete_count(self, athlete_count):
        ...
        if (self._configuration.client_side_validation and
                athlete_count is not None and athlete_count < 1):  # noqa: E501
            raise ValueError(
                "Invalid value for `athlete_count`, must be a value greater than or equal to `1`")  # noqa: E501
