...
class ActivitiesApi(object):
    ...
    def create_activity_with_http_info(self, name, type, start_date_local, elapsed_time, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('start_date_local' not in params or
                                                       params['start_date_local'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('elapsed_time' not in params or
                                                       params['elapsed_time'] is None):  # noqa: E501
