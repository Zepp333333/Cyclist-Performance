...
class DetailedClub(SummaryClub):
    ...
    if hasattr(SummaryClub, "swagger_types"):
        swagger_types.update(SummaryClub.swagger_types)
    ...
    if hasattr(SummaryClub, "attribute_map"):
        attribute_map.update(SummaryClub.attribute_map)

    def __init__(self, membership=None, admin=None, owner=None, following_count=None, *args, **kwargs):  # noqa: E501
        ...
        SummaryClub.__init__(self, *args, **kwargs)
