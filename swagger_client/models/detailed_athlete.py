...
class DetailedAthlete(SummaryAthlete):
    ...
    if hasattr(SummaryAthlete, "swagger_types"):
        swagger_types.update(SummaryAthlete.swagger_types)
    ...
    if hasattr(SummaryAthlete, "attribute_map"):
        attribute_map.update(SummaryAthlete.attribute_map)

    def __init__(self, follower_count=None, friend_count=None, measurement_preference=None, ftp=None, weight=None, clubs=None, bikes=None, shoes=None, *args, **kwargs):  # noqa: E501
        ...
        if shoes is not None:
            self.shoes = shoes
        SummaryAthlete.__init__(self, *args, **kwargs)
