...
class DetailedSegment(SummarySegment):
    ...
    if hasattr(SummarySegment, "swagger_types"):
        swagger_types.update(SummarySegment.swagger_types)
    ...
    if hasattr(SummarySegment, "attribute_map"):
        attribute_map.update(SummarySegment.attribute_map)

    def __init__(self, created_at=None, updated_at=None, total_elevation_gain=None, map=None, effort_count=None, athlete_count=None, hazardous=None, star_count=None, *args, **kwargs):  # noqa: E501
        ...
        SummarySegment.__init__(self, *args, **kwargs)
